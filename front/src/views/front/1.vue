  ...
  <div style="height: 80%; width: 400px;" :style="boxBorder">
    ...
    <div>
      <v-form @submit.prevent>
        ...
        <!-- 往第二頁的按鈕 -->
          <v-col cols="8">
            <v-tabs v-model="tab"   style="background-color: #1BBCA9;">
              <v-tab value="one" block class="mt-2 py-6 rounded-lg" >下一步</v-tab>
              <!-- <v-tab value="two" block class="mt-2 py-6 rounded-lg">下一步</v-tab> -->
            </v-tabs>
          </v-col>
        </v-row>
      </v-form>
