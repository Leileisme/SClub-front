...
const changeText = computed(() => {
  return clickCount.value % 2 === 0 ? '幹部' : props.routeUser.IS_CORE_MEMBER[0].NICK_NAME + '  ' + props.routeUser.IS_CORE_MEMBER[0].CLUB_TH + 'th ' + props.routeUser.IS_CORE_MEMBER[0].ROLE
})
